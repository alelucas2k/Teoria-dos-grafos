...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_w1.adiciona_vertice("E")
        self.g_w1.adiciona_vertice("F")
        self.g_w1.adiciona_aresta('1', 'A', 'B')
        self.g_w1.adiciona_aresta('2', 'A', 'C')
        self.g_w1.adiciona_aresta('3', 'A', 'D')
        self.g_w1.adiciona_aresta('4', 'B', 'D')
        self.g_w1.adiciona_aresta('5', 'B', 'A')
        self.g_w1.adiciona_aresta('6', 'B', 'E')
        self.g_w1.adiciona_aresta('7', 'C', 'D')
        self.g_w1.adiciona_aresta('8', 'D', 'F')
        self.g_w1.adiciona_aresta('9', 'D', 'E')
        self.g_w1.adiciona_aresta('10', 'F', 'A')
        ...
        self.g_w2.adiciona_vertice("F")
        self.g_w2.adiciona_aresta('1', 'A', 'B')
        self.g_w2.adiciona_aresta('2', 'B', 'C')
        self.g_w2.adiciona_aresta('3', 'C', 'E')
        self.g_w2.adiciona_aresta('4', 'D', 'A')
        self.g_w2.adiciona_aresta('5', 'D', 'C')
        self.g_w2.adiciona_aresta('6', 'D', 'F')
        self.g_w2.adiciona_aresta('7', 'E', 'F')
        self.g_w2.adiciona_aresta('8', 'F', 'A')
        ...
        self.g_w3.adiciona_aresta('1', 'A', 'B')
        self.g_w3.adiciona_aresta('2', 'C', 'B')
        self.g_w3.adiciona_aresta('3', 'D', 'B')

        self.g_w4 = MeuGrafo()
        self.g_w4.adiciona_vertice("A")

        self.g_w5 = MeuGrafo()
        self.g_w5.adiciona_vertice("A")
        self.g_w5.adiciona_vertice("B")
        self.g_w5.adiciona_vertice("C")
        self.g_w5.adiciona_vertice("D")
        self.g_w2.adiciona_aresta('1', 'A', 'A')
        self.g_w2.adiciona_aresta('2', 'A', 'B')
        self.g_w2.adiciona_aresta('3', 'A', 'C')
        self.g_w2.adiciona_aresta('4', 'A', 'D')
        self.g_w2.adiciona_aresta('5', 'D', 'D')
        self.g_w2.adiciona_aresta('6', 'D', 'A')
        self.g_w2.adiciona_aresta('7', 'D', 'B')
        self.g_w2.adiciona_aresta('8', 'D', 'C')


        self.g_w1m = self.constroi_matriz(self.g_w1)
        self.g_w1m[0][1] = 1
        self.g_w1m[0][2] = 1
        self.g_w1m[0][3] = 1
        self.g_w1m[1][3] = 1
        ...
        self.g_w2m = self.constroi_matriz(self.g_w2)
        self.g_w2m[0][1] = 1
        self.g_w2m[1][2] = 1
        self.g_w2m[2][4] = 1
        self.g_w2m[3][0] = 1
        ...
        self.g_w3m = self.constroi_matriz(self.g_w3)
        self.g_w3m[0][1] = 1
        self.g_w3m[2][1] = 1
        self.g_w3m[3][1] = 1

        self.g_w4m = self.constroi_matriz(self.g_w4)

        self.g_w5m = self.constroi_matriz(self.g_w5)
        for i in range(0, len(self.g_w5m)):
            self.g_w5m[0][i] = 1
            self.g_w5m[3][i] = 1
    ...
    def test_warshall(self):
        ...
        self.assertTrue(self.g_w1.warshall(), self.g_w1m)
        self.assertTrue(self.g_w2.warshall(), self.g_w2m)
        self.assertEqual(self.g_w3.warshall(), self.g_w3m)
        self.assertEqual(self.g_w4.warshall(), self.g_w4m)
        self.assertTrue(self.g_w5.warshall(), self.g_w5m)
